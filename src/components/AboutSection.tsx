...
import panditPortrait from "@/assets/pandit-portrait.jpg";
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group">
            ...
            <img 
              ...
              className="relative z-10 w-full h-[500px] object-cover rounded-xl shadow-cosmic hover:shadow-sacred transition-all duration-500"
            />
